...
fit0 = fit_data_copula_rt(df %>% filter(cohort == "vmp1"),ACC = F, "VMP1",modeltype = "pure",conf = "ord_beta")
fit1 = fit_data_copula_rt(df %>% filter(cohort == "vmp1"),ACC = F, "VMP1",modeltype = "meta_un",conf = "ord_beta")
fit2 = fit_data_copula_rt(df %>% filter(cohort == "vmp1"),ACC = F, "VMP1",modeltype = "meta_un_rt_un",conf = "ord_beta")
