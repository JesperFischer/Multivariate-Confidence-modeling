...
Citation: WT Adler, WJ Ma. (2018). Comparing Bayesian and non-Bayesian accounts of human confidence reports.
PLOS Computational Biology. 14(11): e1006572. https://doi.org/10.1371/journal. pcbi.1006572

These data are from Experiment 3.

Stimulus and task:
During each session, each subject completed an orientation categorization task (referred to as Task B in the other experiments from this paper).
The stimuli were drifting Gabors. On each trial, a category C was selected randomly (both categories were equally probable),
...
The categories were defined by normal distributions on orientation. The distributions had the same mean (0°) and different standard deviations (σ_1, σ_2);
