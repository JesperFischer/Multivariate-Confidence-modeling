...
Stimulus
Gabor patches. For task 1 (coarse discrimination), the Gabor patches were embedded in noise and tilted 45 degrees away from the vertical.
For task 2 (fine discrimination), the Gabor patches were tilted slightly (~1 degree) away from vertical.
1: left (counterclockwise) orientation, 2: right (clockwise) orientation.
