...
Citation:
Desender, K., Van Opstal, F., & Van den Bussche, E. (2014). Feeling the conflict.
The crucial role of conflict experience in adaptation.Psychological Science, 25(3).

Stimulus:
Priming arrows that pointed either leftwards (L) or rightwards (R).
These were preceeded by masked priming arrows that either pointed in the same direction (Congr) or the other direction (Incongr),
as indicated by the column 'Congruency'.
