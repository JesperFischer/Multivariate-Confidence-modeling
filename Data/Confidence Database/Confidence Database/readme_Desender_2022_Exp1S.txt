...
These data are from Experiment 1S (reported in the Supplementary info). Note, due to COVID-19 data were collected online.
...
Confidence Scale: continousus scale running from "certainly wrong" to "certainly correct"
